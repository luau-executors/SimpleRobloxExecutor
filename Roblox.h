...
{
    const uintptr_t Print = REBASE(0x15C9CD0); // Updated
    const uintptr_t TaskDefer = REBASE(0x1081760); // Updated
    const uintptr_t LuaVMLoad = REBASE(0xC5CA50); // Updated
    const uintptr_t GetGlobalState = REBASE(0xEA35D0); // Updated
    const uintptr_t DecryptLuaState = REBASE(0xC59A30); // Updated
    const uintptr_t RawScheduler = REBASE(0x627D908); // Updated
}
